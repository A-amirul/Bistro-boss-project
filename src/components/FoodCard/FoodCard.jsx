				...
				.then(data => {
					if (data?.insertedId) {
						...
						Swal.fire({
							position: 'top-end',
							icon: 'success',
							title: 'Your Food Item is saved in cart',
		...
		<div className="card w-96 bg-base-100 shadow-xl">
			...
			<div className="card-body flex flex-col items-center">
				...
				<div className="card-actions justify-end">
					<button onClick={() => handleAddToCart(item)} className="btn btn-outline border-0 border-b-4 bg-slate-100 border-orange-400 mt-4">Add to Cart</button>
				</div>
			</div>
		</div>
	);
